...
**** Exercise 2.21
I admit that I couldn't fully understand the statement of this exercise; but
code it was irrelevant with it. I can not be sure whether the author intended
it, anyway I did it:
#+BEGIN_SRC sml
fun introot n =
    if n=0 then 0 else
...
#+END_SRC
It has linear complexity in both space and time. As we can prove the ~fun P n =
n~ by induction on n, it is way more faster to define like that than above.
**** Exercise 2.24
